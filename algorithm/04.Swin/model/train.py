...
def main(define_model:str='self',
    ...
    if define_model == 'timm_v1':
        model_name = f'swin_{model_type}_patch{patch_size}_window{window_size}_{img_size}.ms_in22k'
        
    elif define_model == 'timm_v2':
        model_name = f'swinv2_cr_{model_type}_ns_{img_size}.sw_in1k'
        
    elif define_model == 'v1':
        args = {}
        if model_type == 'small':
            args['embed_dim'] = 96
    ...
    if 'v1' in define_model:
        max_norm = 1.0
    elif 'v2' in define_model:
        max_norm = 5.0
