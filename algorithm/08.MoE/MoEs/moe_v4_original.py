...
class MoE_Original(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.classifier(output), load_balance_loss
...
if __name__ == "__main__":
    ...
    MoE_model = MoE_Original(input_dim, output_dim, num_experts, topk=topk, noise_std=noise_std)
